    ...
    public Message getTopAndBottomPlants(Principal principal, int n) {
        ...
        if (principal == null) {
            ...
            if(user!=null){
                ...
                message.setCode(ConstantValues.SERVICE_UNAUTHORIZED).setStatus(ConstantValues.SERVICE_UNSUCCESS_STATUS).setMessage("User not found");
            }
        }
        ...
        if (principal == null) {
            ...
            if (user == null) {
                ...
                if(!plantList.isEmpty() || plantList!=null){
                    ...
                    message.setCode(ConstantValues.SERVICE_NOT_FOUND).setStatus(ConstantValues.SERVICE_UNSUCCESS_STATUS).setMessage("Location not found");
                }
            }
        }
        return message;
